    ...
    <div className="space-y-8 max-w-6xl mx-auto">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs mt-1 text-garage-white/90 font-body">
                Your subscription expires on {formatDate(member?.expiry_date)}. Visit reception to renew.
              </p>
            </div>
          </div>
          <Link to={ROUTES.MEMBER_MEMBERSHIP} className="shrink-0 hidden sm:block">
            <Button variant="outline" size="sm" className="border-status-pending text-status-pending hover:bg-status-pending/20">
              View Plan
            </Button>
          </Link>
        </div>
        ...
        <div className="p-4 rounded-xl bg-status-expired/10 border border-status-expired/40 flex items-start justify-between gap-4 text-status-expired">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs mt-1 text-garage-white/90 font-body">
                Your membership expired on {formatDate(member?.expiry_date)}. Please renew at front desk.
              </p>
            </div>
          </div>
          <Link to={ROUTES.MEMBER_MEMBERSHIP} className="shrink-0 hidden sm:block">
            <Button variant="outline" size="sm" className="border-status-expired text-status-expired hover:bg-status-expired/20">
              Renewal Info
            </Button>
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-3 text-garage-chrome">
            ...
            <h4 className="text-xs font-bold uppercase tracking-wider text-garage-muted">Subscribed Tier</h4>
          </div>
          <p className="text-2xl font-display text-garage-white uppercase">
            {member?.plan ? `${member.plan.tier.toUpperCase()} (${member.plan.duration})` : 'Standard Pass'}
          </p>
          <div className="mt-4 pt-3 border-t border-garage-mid/40">
            <Link to={ROUTES.MEMBER_MEMBERSHIP} className="text-xs text-garage-chrome hover:underline flex items-center gap-1 font-semibold">
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-3 text-garage-chrome">
            ...
            <h4 className="text-xs font-bold uppercase tracking-wider text-garage-muted">Expiry Date</h4>
          </div>
        ...
        <Card className="p-6">
          <div className="flex items-center gap-3 mb-3 text-garage-chrome">
            ...
            <h4 className="text-xs font-bold uppercase tracking-wider text-garage-muted">Floor Access</h4>
          </div>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-garage-mid">
          ...
          <Link to={ROUTES.MEMBER_PAYMENTS} className="text-xs text-garage-chrome hover:underline font-semibold flex items-center gap-1">
