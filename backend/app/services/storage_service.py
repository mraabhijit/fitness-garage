...
def get_public_asset_url(file_path: str) -> str:
    ...
    e.g. assets/trainers/trainer-one.jpg -> https://<project>.supabase.co/storage/v1/object/public/assets/trainers/trainer-one.jpg
    """
...
async def get_invoice_signed_url(invoice_path: str, expires_in: int = 3600) -> str:
    ...
    try:
        ...
        if settings.SUPABASE_URL and settings.SUPABASE_SERVICE_KEY:
            ...
            path_in_bucket = invoice_path.replace("invoices/", "", 1) if invoice_path.startswith("invoices/") else invoice_path
